...
<body>
    ...
    <div class="container">
        <form action="{{route('tiket.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center pt-5 pb-5">Silahkan Pesan Tiket Anda</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input name="nama" class="form-control" id="exampleFormControlInput1">
                            </div>
                        </div>
                        <div class="col-3"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input name="nomor" class="form-control" id="exampleFormControlInput1">
                            </div>
                        </div>
                        <div class="col-3"></div>
                    </div>
